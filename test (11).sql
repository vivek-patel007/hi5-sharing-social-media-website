...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2021 at 11:47 AM
...
(1, 'vp67176@gmail.com', '222222', 'user', '0000-00-00 00:00:00.000000', 0),
...
INSERT INTO `tbl_packagebooking` (`Booking_ID`, `Amounts`, `Payment_Status`, `Timestamp`, `Package_ID_id`, `user_email`, `is_active`) VALUES
(1, 1000, 'pending', '2021-04-15 15:26:52', 2, 'vp67176@gmail.com', 1);
...
ALTER TABLE `tbl_packagebooking`
  ...
  ADD KEY `tbl_packagebooking_Package_ID_id_485bf3b6_fk_tbl_packa` (`Package_ID_id`);
...
--
ALTER TABLE `tbl_packagebooking`
  ADD CONSTRAINT `tbl_packagebooking_Package_ID_id_485bf3b6_fk_tbl_packa` FOREIGN KEY (`Package_ID_id`) REFERENCES `tbl_package` (`package_id`);
