...
<?php
global $package_price,$email_id;
include("partial/_db.php");
$sql="select * from tbl_packagebooking";
                              ...
                              <div class="iq-card">
                                 <div class="iq-card-header d-flex justify-content-between">
                                    <div class="iq-header-title">
                                       ...
                                       <div class=" row align-items-center ml-5 mx-10" style="margin-top: 65px;">
                                          <div class="form-group col-sm-6">
                                             <label for="fname">Order id:*</label>
											 <input id="ORDER_ID" class="form-control" tabindex="1" name="ORDER_ID" value="<?php echo  "ORDS" . rand(10000,99999999)?>">
