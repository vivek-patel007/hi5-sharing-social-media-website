...
?>
        ...
        <section class="banner--section">
            ...
            <div class="banner--slider owl-carousel" data-owl-dots="true">
                <!-- Banner Item Start -->
                <div class="banner--item" data-bg-img="img/group-img/03.jpg" data-overlay="0.5">
                    <div class="vc--parent">
                        <div class="vc--child">
                            <div class="container">
                                <div class="row">
            ...
            Extra large
                ...
                <!-- Banner Item Start -->
                <div class="banner--item" data-bg-img="img/group-img/11.jpg" data-overlay="0.5">
                    <div class="vc--parent">
                        <div class="vc--child">
                            <div class="container">
                                <div class="row">
            ...
            Extra large
              ...
              <form> -->
                ...
                <!-- Banner Item Start -->
                <div class="banner--item" data-bg-img="img/group-img/06.jpg" data-overlay="0.5">
                    <div class="vc--parent">
                        <div class="vc--child">
                            <div class="container">
                                <div class="row">
                    ...
                    <div class="col-md-5 pb--40">
                        ...
                        <div class="info--items" data-scroll-reveal="group">
                            ...
                            <div class="info--item clearfix">
                                ...
                                <div class="info">
                                    <div class="title">
                                        <h3 class="h4 fw--700">sharing Images &amp; Videos</h3>
                                    </div>
